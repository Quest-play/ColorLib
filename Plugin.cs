...
public static class TextColor
{
    ...
    // Green Colors
    public static readonly String Green = "#008A00";
    ...
    public static readonly String Olive = "#7D7D00";
    ...
    public static readonly String Teal = "#007D7D";
    ...
    public static readonly String LightGoldenrod = "#EEDD82";
    ...
    public static readonly String DarkBrown = "#654321";
    ...
    // Quickly create color from int hex (RRGGBB)
    public static String FromHex(String hex) => $"#{hex}";

    // Quickly create color from RGB components
    public static String FromRgb(byte r, byte g, byte b) => $"#{r:X2}{g:X2}{b:X2}";
}